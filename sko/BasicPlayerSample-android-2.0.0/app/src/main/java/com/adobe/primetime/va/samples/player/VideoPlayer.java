...
public class VideoPlayer extends Observable {
    ...
    // This sample VideoPlayer simulates a mid-roll ad at time 15: DISABLED FOR SKO!
    private static final Double AD_START_POS = 999D;
    private static final Double AD_END_POS = 999D;
    private static final Double AD_LENGTH = 1D;

    private static final Double CHAPTER1_START_POS = 0D;
    private static final Double CHAPTER1_END_POS = 599D;
    private static final Double CHAPTER1_LENGTH = 599D;

    private static final Double CHAPTER2_START_POS = 999D;
    private static final Double CHAPTER2_LENGTH = 1D;
