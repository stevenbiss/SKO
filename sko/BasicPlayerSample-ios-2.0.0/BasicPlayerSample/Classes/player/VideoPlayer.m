...
NSUInteger const AD_START_POS = 999;
NSUInteger const AD_END_POS = 999;
NSUInteger const AD_LENGTH = 1;

NSUInteger const CHAPTER1_START_POS = 0;
NSUInteger const CHAPTER1_END_POS = 599;
NSUInteger const CHAPTER1_LENGTH = 599;

NSUInteger const CHAPTER2_START_POS = 999;
NSUInteger const CHAPTER2_LENGTH = 1;
