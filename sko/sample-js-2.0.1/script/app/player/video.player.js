...
(function() {
    ...
    var AD_START_POS = 999;		// 15
    var AD_END_POS = 999;   		// 30
    var AD_LENGTH = 1;			// 15

    var CHAPTER1_START_POS = 0;	// 0
    var CHAPTER1_END_POS = 599;	// 15
    var CHAPTER1_LENGTH = 599;	// 15

    var CHAPTER2_START_POS = 999;	// 30
    var CHAPTER2_LENGTH = 1;		// 30

    var MONITOR_TIMER_INTERVAL = 500; 	// 500
    ...
    function VideoPlayer(id) {
        ...
        this._streamType = document.getElementById("streamtype").value;
