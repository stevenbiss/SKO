...
(function() {
    ...
    function VideoAnalyticsProvider(player) {
        ...
        // appMeasurement.visitorID = "test-vid"; (use MCID cookie)
    ...
    VideoAnalyticsProvider.prototype._onLoad = function() {
		...
		var skotest = document.getElementById("yourname").value + ' | ' + document.getElementById("testname").value;
        var contextData = {
            isUserLoggedIn: "false",
            tvStation: "Sample TV station",
            programmer: "Sample programmer",
			pageName: Configuration.APP_MEASUREMENT.PAGE_NAME,
			streamType: document.getElementById("streamtype").value,
			sko_source: "JavaScript SDK",
			sko_tester: document.getElementById("yourname").value,
			sko_testname: skotest,
			sko_testdatetime: document.getElementById("testdatetime").value,
			sko_prid: document.getElementById("sko_prid").value,
			sko_ty: document.getElementById("sko_ty").value,
			sko_dt: document.getElementById("sko_dt").value,
			sko_t: document.getElementById("sko_t").value,
			sko_stid: document.getElementById("sko_stid").value,
			sko_pr: document.getElementById("sko_pr").value,
			sko_begin: document.getElementById("sko_begin").value,
			sko_end: document.getElementById("sko_end").value,
			sko_cl: document.getElementById("sko_cl").value,
			sko_starts_nl: document.getElementById("sko_starts_nl").value,
			sko_starts_onb: document.getElementById("sko_starts_onb").value,
			sko_starts_btl: document.getElementById("sko_starts_btl").value,
			sko_nlziet: document.getElementById("sko_nlziet").value,
			sko_idfa: document.getElementById("sko_idfa").value,
			sko_gen: document.getElementById("sko_gen").value,
			sko_pub: document.getElementById("sko_pub").value
        };
